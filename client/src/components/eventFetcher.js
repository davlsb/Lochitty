...
export default function EventCard(props) {
  ...
  return (
    <Card className="p-4 d-flex border-bottom" sx={{display: 'grid', marginLeft:"2.5em", width: "93%", borderRadius: 4, marginBottom: 2, border: 0, boxShadow: 7 }}>
      ...
      <Typography >{props.data.eventType}</Typography>
      ...
      <CardMedia className="p-1 rounded-circle" style={{width:"15em",height:"10em" }}
        component="img"
      ...
      <Collapse className="d-flex flex-direction-column" in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
